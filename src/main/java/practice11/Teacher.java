...
public class Teacher extends Person implements CallTeacher{
    ...
    @Override
    public  void callTeacherTheLeader(Student student){
        System.out.print("I am "+name+". I know "+student.name+" become Leader of Class "+student.getKlassNumber()+".\n");
    }
    @Override
    public  void callTeacherInClass(Student student){
